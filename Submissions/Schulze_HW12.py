...
# Find the last week's average temperature. If the most recent temperature is lower,
# set the variable use_historical to true

print(lwt.round(2))
temp.tail(1)
if lwt.round(2) >= temp.tail(1):
    use_historical = True
else:
