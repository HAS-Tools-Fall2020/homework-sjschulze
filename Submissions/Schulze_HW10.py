# Scott Schulze
# 10/29/2020
# Forecasting code for week 10, using an AR model, with two datasets
# retrieved via rest API. Then not used. Going old school with the forecast
# and just plain guessing; it has yielded my best results to date.
...
args = {
    ...
    'end': '202010310000',                # Update this on Sunday
    'obtimezone': 'UTC',
    'vars': 'air_temp',
    'stids': 'QVDA3',
    'units': 'temp|F',
...
site = '09506000'
start = '1990-01-01'
end = '2020-10-31'      # Update this on Sunday
...
# %%
# Plot the new data, to get an idea of how it looks, at least it used to...
# This is non-functioning and I have no idea why.
plt.subplot(data_weekly.tail(13), color='green')
plt.subplot(flow_weekly.tail(13), color='blue')
# I do not like how this x-axis label looks, and would like to fix it.
plt.xlabel('Date')
