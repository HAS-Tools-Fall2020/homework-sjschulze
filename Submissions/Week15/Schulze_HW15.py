...
args = {
    ...
    'end': '202012030000',                # Update this on Sunday
    'obtimezone': 'UTC',
    'vars': 'air_temp',
    'stids': 'QVDA3',
    'units': 'temp|F',
...
print("Last week's average temperature was ", lwt, "$^\circ$F.")
...
site = '09506000'
start = '1990-01-01'
end = '2020-12-03'      # Update this on Sunday
...
# temperature is also considered, adding 82 cfs if the average weekly
# temperature was less than 80F. This is meant to be run by the person
...
for i in range(len(flow_prediction)):
    print(i)
    if lwt.values <= 80:
        print("Please enter ", flow_prediction[i].round(1)+82,
